...
describe('polygonArea', () => {
  ...
  it('computes area of a triangle', () => {
    expect(polygonArea(triangle)).toBeCloseTo(100);
  });
...
describe('rotatePolygon', () => {
  ...
  it('rotates around centroid by default', () => {
    ...
    expect(rc.x).toBeCloseTo(c.x);
    expect(rc.y).toBeCloseTo(c.y);
  });
